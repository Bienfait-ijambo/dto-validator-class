...
function IsEmail(target, propertyKey) {
    new CreateValidationRule_1.CreateValidationRule(PropMetaData_1.propMeta).execute({ propertyKey: propertyKey,
        validationType: validationList_1.ValidationList.EMAIL }, target);
}
