...
(0, node_test_1.default)("Util test suite", (t) => __awaiter(void 0, void 0, void 0, function* () {
    yield t.test("should  get rules added to a class", (t) => __awaiter(void 0, void 0, void 0, function* () {
        class MyClass {
        }
        __decorate([
            Required_1.Required,
        ...
        const requiredProp = Reflect.get(rules_1.rulesArray, "required");
        expectedInput.push({ email: emailProp }, { required: requiredProp });
        node_assert_1.default.deepStrictEqual(expectedInput, validationRules);
    }));
}));
